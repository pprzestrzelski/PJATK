...
public class Currency 
{
	...
	public void setRate(Double rate)
	{
		...
		{
			throw new IllegalArgumentException("Currency rate has to be > 0.0 as well as =! -0.0");
		}
		this.rate = rate;
	}
	
	/** Set valid name for Currency
	 * 
	 * @param name valid name for Currency
	 * */
	public void setName(String name)
	{
		...
		{
			throw new IllegalArgumentException("Name has to be three letter long.");
		}
	...
	*/
	...
	{
		return (int)(othercurrency.universalValue(amount) / getRate());
	}
}
