...
public class Money implements Comparable<Object> 
{
	 ...
	 * @return Amount of money in Double type.		// Double? <==> Integer?
	 */
	...
	{
		return getAmount() / 100.0 + " " + getCurrency().getName();
	}
	...
	{
		return getCurrency().universalValue(getAmount());
	}
	...
	{
		Integer newAmount = getAmount() + getCurrency().valueInThisCurrency(other.getAmount(), other.getCurrency());
