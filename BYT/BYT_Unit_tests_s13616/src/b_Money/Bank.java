...
public class Bank 
{
	...
	public void openAccount(String accountid) throws AccountExistsException 
	{
		...
		{
			// TODO: Zamiast dodawac konto, metoda zwracala nieistniejace konto accountlist.get(accountid);
			// 		 Wykryto jak w przypadku metody deposit() oraz metoda testowa klasy BankTest
			//		 testOpenAccountWhichExists().
	 ...
	 * @return true if contains accountid, false otherwise
	 * */
	...
	{
		// TODO: Odwrocona logika: by³o accountlist.containsKey(accountid)
		// 		 Wykryto testujac klase Account. Klasa AccountTest w metodzie setUp() 
		//		 dla operacji SweBank.deposit("Alice", new Money(1000000, SEK)) rzucala NullPointerException
		//		 oraz metoda testDepositToNonExistingAccount() klasy BankTest.
		if (!accountlist.containsKey(accountid)) 
		{		
	...
	public void withdraw(String accountid, Money money) throws AccountDoesNotExistException 
	{
		...
		{
			Account account = accountlist.get(accountid);
			// TODO: Zamiast deposit(money) powinno byc withdraw(money)
			//		 Wykryto metoda testWithdraw() klasy BankTest
			//account.deposit(money);
	...
	{
		// TODO: Konto zrodlowe i docelowe takie same: transfer(fromaccount, this, fromaccount, amount)
		//		 Wykryto metodami testTransferToWrongAccount()
		//		 oraz testTransfer() z klasy BankTest.
	...
	{
		// TODO: Dodano po wykoaniu testu testTimedPaymentAddToNotExistingAccount() z klasy BankTest
	...
	{
		// TODO: Dodano po wykoaniu testu testTimedPaymentRemoveFromNonExistingAccount() z klasy BankTest
		if (!accountExists(accountid))
		{
			throw new AccountDoesNotExistException();
		}
	 ...
	 */
	public void tick() /*throws AccountDoesNotExistException*/	// Is this exception really needed?
	{
